...
df_female['female_wellbeing_mean'] = df_female.iloc[:, 11:].mean(axis=1)

# Display the DataFrame with the new column
print(df_female[['ID', 'C_we', 'C_wk', 'G_we', 'G_wk', 'S_we', 'S_wk', 'T_we', 'T_wk', 'female_wellbeing_mean']])
df_female[['ID', 'C_we', 'C_wk', 'G_we', 'G_wk', 'S_we', 'S_wk', 'T_we', 'T_wk', 'female_wellbeing_mean']].to_csv('female_wellbeing.csv', index=False)
